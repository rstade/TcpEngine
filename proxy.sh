...
echo $executable
sudo -E env "PATH=$PATH" perf stat -e L1-dcache-loads,L1-dcache-load-mis.ses,L1-dcache-stores,L1-dcache-store-misses,LLC-loads,LLC-load-misses,cache-references,cache-misses $executable $1
